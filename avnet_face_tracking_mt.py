...
def taskWorker(worker,detThreshold,nmsThreshold,ct,queueIn,queueOut):
...
def main(argv):
    ...
    for i in range(threads):
        tw = threading.Thread(target=taskWorker, args=(i,detThreshold,nmsThreshold,ct,queueIn,queueOut))
        threadAll.append(tw)
